...
import project_6 from '../../assets/aiCodeGen.png'
const Projects = () => {
  ...
  const proTech6 = ["React", "CSS", "Express.js", "Node.js","MongoDB Atlas","Gemini API" ];
  ...
  const aiCodeGen = { git: `https://github.com/Kapil-9762/AI-code-generator-frontend`, live: `https://ai-codegenapp.vercel.app/` };

  return (
    <div className='projects container'>
         <Project project={project_6} title="AI based Code Gen" disc="An AI-powered MERN stack application with secure authentication, Gemini API integration, Monaco editor, and a fully responsive UI that generates clean frontend code from user prompts." proTech={proTech6} projectsLinks={aiCodeGen}/>
